...
\titleformat{\subsection}{
    \vspace{-10pt}\color{black!40}\sffamily\bfseries\raggedright\footnotesize
}{}{0em}{\vspace{-10pt}}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.linkedin.com/in/patrick-ramsey-2bb73a27/}{LinkedIn} & Mobile:~~~(508) 333-6120 \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Staff Software Engineer}{September}
    \subsection{Engineering and Problem Solving}
      \resumeItemListStart
        ...
        \resumeItem{Client Android 5 Backport}{Backported our Instore app to Android 5 in one month after it was discovered at the last minute that we wouldn't be able to target more recent Android}
        ...
        \resumeItem{Bathroom Monitor}{Part of a team that built a sensor system and website to monitor when the office's few bathrooms were available}
      \resumeItemListEnd

    \subsection{Infrastructure Improvements}
      \resumeItemListStart
        \resumeItem{Vault}{Selected Hashicorp Vault as our secrets management solution, and implemented a proof of concept deployment on Kubernetes}
